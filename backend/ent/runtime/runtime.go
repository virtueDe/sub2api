...
func init() {
	...
	// groupDescIsPaidEntitlement is the schema descriptor for is_paid_entitlement field.
	groupDescIsPaidEntitlement := groupFields[8].Descriptor()
	// group.DefaultIsPaidEntitlement holds the default value on creation for the is_paid_entitlement field.
	group.DefaultIsPaidEntitlement = groupDescIsPaidEntitlement.Default.(bool)
