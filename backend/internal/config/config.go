...
func setEnvReachableDefaults() {
	...
	viper.SetDefault("gateway.image_url_proxy.cache_ttl_hours", 0)
	viper.SetDefault("gateway.image_url_proxy.domain_whitelist", []string{})
	viper.SetDefault("gateway.image_url_proxy.max_download_bytes", int64(0))
	viper.SetDefault("gateway.image_url_proxy.storage_key_prefix", "")
	viper.SetDefault("gateway.image_url_proxy.whitelist_only", false)
