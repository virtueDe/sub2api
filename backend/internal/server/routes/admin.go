...
func registerGroupRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	groups := admin.Group("/groups")
	{
		...
		groups.GET("/paid-entitlement-preview", h.Admin.Group.PreviewPaidEntitlementSync)
		...
		groups.POST("/:id/paid-entitlement", h.Admin.Group.ActivatePaidEntitlement)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/image-generation-capable", h.Admin.Account.ListImageGenerationAccounts)
...
func registerUsageRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	usage := admin.Group("/usage")
	{
		...
		usage.GET("/daily-token-ranking-reward", h.Admin.Usage.DailyTokenRankingRewardPreview)
		usage.POST("/daily-token-ranking-reward/settle", h.Admin.Usage.DailyTokenRankingRewardSettle)
	}
}
