...
func NewOpenAIGatewayService(
	...
	return NewOpenAIGatewayServiceWithImageURLProxy(
		accountRepo,
		usageLogRepo,
		usageBillingRepo,
		userRepo,
...
// NewOpenAIGatewayServiceWithImageURLProxy creates the production gateway with
// the optional image URL proxy dependencies.
func NewOpenAIGatewayServiceWithImageURLProxy(
	accountRepo AccountRepository,
	usageLogRepo UsageLogRepository,
	usageBillingRepo UsageBillingRepository,
	userRepo UserRepository,
