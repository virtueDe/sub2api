export default {
    ...
    users: {
      ...
      searchPlaceholder: 'Search by user ID, email, username, notes, or API key...',
      searchUsers: 'Search by user ID, email, username, notes, or API key',
    ...
    groups: {
      ...
      form: {
        ...
        paidEntitlement: 'Paid Entitlement Group',
        paidEntitlementHint: 'After saving, review historical paid users before syncing access and unused paid redeem codes',
      ...
      paidEntitlement: {
        previewTitle: 'Confirm Paid Entitlement Sync',
        previewDescription: 'These users redeemed an integer balance code worth at least 10. Confirm to grant this group to them and append it to eligible unused paid redeem codes.',
        userCount: 'Users to sync',
        unusedCodeCount: 'Unused codes to update',
        user: 'User',
        codeCount: 'Eligible redeemed codes',
        totalAmount: 'Total redeemed amount',
        currentGroups: 'Current exclusive groups',
        noUsers: 'No historical paid users match the rule',
        disableHint: 'Disabling this option later stops future grants but does not revoke groups users already have.',
        confirm: 'Confirm and sync',
        syncing: 'Syncing...',
        previewFailed: 'The group was saved, but the paid-user preview failed. Retry from Edit Group.',
        syncSuccess: 'Sync complete: processed {users} users and updated {codes} unused codes',
        syncFailed: 'Sync failed. Paid entitlement was not enabled; you can confirm again to retry.'
      },
