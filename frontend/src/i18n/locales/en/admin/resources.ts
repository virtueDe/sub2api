export default {
    ...
    redeem: {
      ...
      codeType: 'Code Type',
      amount: 'Amount ($)',
      entitlementProfile: 'Paid entitlement profile',
      entitlementNone: 'No exclusive groups',
      entitlementPaidDefault: 'Paid user exclusive groups',
      entitlementGroups: 'Exclusive groups (multi-select)',
      noEntitlementGroups: 'No available exclusive groups',
      entitlementGroupsRequired: 'Select at least one exclusive group',
      value: 'Value',
      count: 'Count',
