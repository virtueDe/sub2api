export default {
    ...
    redeem: {
      ...
      codeType: '类型',
      amount: '金额 ($)',
      entitlementProfile: '付费权益配置',
      entitlementNone: '不附加专属分组',
      entitlementPaidDefault: '付费用户专属分组',
      entitlementGroups: '专属分组（可多选）',
      noEntitlementGroups: '暂无可用的专属分组',
      entitlementGroupsRequired: '请选择至少一个专属分组',
      value: '面值',
      count: '数量',
      generate: '生成',
      copyAll: '全部复制',
